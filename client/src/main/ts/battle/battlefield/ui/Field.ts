...
import { Subject, PathNode, Target } from "../../../model/util";
...
export class Field extends druid.ScrollContainer {
    ...
    constructor(private readonly size: druid.Point, units: Unit[], asteroids: druid.Point[], clouds: druid.Point[],
        ...
        unitService.on(Subject.Move, () => this.updatePathsAndMarks());
        unitService.on(Subject.Shot, () => this.updatePathsAndMarks());
        ...
        unitService.on(Subject.NextTurn, () => this.updatePathsAndMarks());
